<template>
	<div id="app">
		...
		<el-row v-show="isRoot">
			<el-col :span="4">
				<el-button type="primary" icon="el-icon-plus" size="small" @click="openAddAccountWin">添加</el-button>
			</el-col>
		</el-row>
		<!--工具栏与数据表格之间间隙-->
			...
			<el-table-column label="操作" width="350" align="center" v-if="isRoot">
				<template slot-scope="scope">
					<el-form :inline="true" size="small">
						...
						<el-form-item>
							<el-button type="primary" icon="el-icon-refresh" @click="resetAccountPwd(scope.row)">
								重置密码</el-button>
						</el-form-item>
						<el-form-item>
							<el-switch :active-value="1" :inactive-value="0"
								:disabled="scope.row.role == 1 ? true : false" @change="switchChange(scope.row)"
